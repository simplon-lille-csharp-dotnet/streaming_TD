...
CREATE TABLE SMG_Favorite(
	...
	FOREIGN KEY(SMO_MOVIEID) REFERENCES SMG_Movie(SMO_MOVIEID)
);
...
ALTER TABLE SMG_Movie ADD COLUMN SMG_DIRECTORID serial;
ALTER TABLE SMG_Movie ADD FOREIGN KEY(SMO_DIRECTORID) REFERENCES SMG_Director(SDI_DIRECTORID);